...
vector<point> convexHull(vector<point> pontos){
...
int main() {
    ...
    while(1) {
        ...
        pontos.push_back(point(0,8));
        pontos.push_back(point(1,6));
        pontos.push_back(point(8,7));
        pontos.push_back(point(6,6));
        pontos.push_back(point(8,0));
        pontos.push_back(point(3,1));


		vector<point> convexhull = convexHull(pontos);
    }
